  ...
  return (
    <div className="min-h-screen pt-24 pb-12">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        {!isAuthenticated && (
          <div className="mb-6 p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl text-sm text-amber-600 flex items-center justify-between">
            <span>Sign in to complete your booking and track your trips.</span>
              ...
              <div className="space-y-4">
                <img
                  ...
                  onError={(e) => {
                    ...
                    target.onerror = null;
                    target.src = `https://picsum.photos/seed/${destination.id}/800/400`;
                  }}
                />
